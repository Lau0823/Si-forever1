      ...
      <div className="relative z-10 flex h-full items-end p-5 sm:p-8">
        <div className="max-w-2xl">
          ...
          <div className="mt-5 flex items-center gap-2">
            ...
            <div className="ml-2 rounded-full bg-black px-3 py-2 text-[12px] font-semibold text-white backdrop-blur-md tabular-nums">
              {idx + 1}/{images.length}
            </div>
          </div>
        </div>
      ...
      <div className="relative mx-auto mt-10 w-[min(980px,94vw)]">
        <div className="paperTexture relative overflow-hidden rounded-[28px] border border-black/10 bg-white shadow-[0_30px_90px_rgba(0,0,0,0.28)]">
          ...
          <div className="border-t border-black/10 px-5 py-4">
            <button type="button" onClick={onClose} className={cn(btnBlack, "w-full")}>
              Cerrar
            </button>
          </div>
        </div>
...
function GiftModal({ open, onClose, gifts }: { open: boolean; onClose: () => void; gifts: string[] }) {
  ...
  const btnBlack =
    "inline-flex items-center justify-center rounded-full bg-black px-4 py-4 text-sm font-semibold tracking-[0.16em] uppercase text-white transition hover:bg-black/90 active:scale-[0.99] disabled:opacity-50";
                ...
                <div className="space-y-6">
                  ...
                  <div className={cn(cardDark, "p-6")}>
                    ...
                    <div className="mt-4 grid gap-3">
                      <div>
                        <label className="text-[11px] font-semibold tracking-[0.14em] uppercase text-white/60">Canción</label>
                        <input
                          value={song.name}
                      ...
                      <div>
                        <label className="text-[11px] font-semibold tracking-[0.14em] uppercase text-white/60">Artista</label>
                        <input
                          value={song.artist}
                      ...
                      <div>
                        <label className="text-[11px] font-semibold tracking-[0.14em] uppercase text-white/60">Link (opcional)</label>
                        <input
                          value={song.link}
